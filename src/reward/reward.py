...
class FitnessFunction:
    def __init__(self, M, g, T, Bt, fr, mu, m, Tb, m1, m2, m3, L0, L1, L2, L3, I1, I2, I3, L = None):
        self.mod_zmp = reward.ModZMP(M, g, T, Bt, fr, mu, m, Tb, m1, m2, m3, L0, L2, L2, L3, I1, I2, I3, L)
    
    def build(self, t, A, B, AL, AF, BF, BL):
        self.A = A
        self.B = B
        self.mod_zmp.build(t, A, B, AL, AF, BF, BL)
